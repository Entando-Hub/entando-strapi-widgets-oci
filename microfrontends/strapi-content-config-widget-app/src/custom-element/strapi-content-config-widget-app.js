...
class StrapiWidgetConfigApp extends HTMLElement {
    constructor() {
        super();
...
customElements.define('strapi-content-config-widget-app', StrapiWidgetConfigApp);

export default StrapiWidgetConfigApp;
