...
class StrapiContentTemplateApp extends HTMLElement {
...
customElements.get('strapi-content-template-app') || customElements.define("strapi-content-template-app", StrapiContentTemplateApp)