...
class StrapiWidgetApp extends HTMLElement {
...
customElements.get('strapi-content-widget-app') || customElements.define('strapi-content-widget-app', StrapiWidgetApp);

export default StrapiWidgetApp;
